...
function SearchForm({
  placeholder, filterData, setFilter
}) {
  ...
  const handleSearch = (e) => {
    ...
    (searchText==='')?
      setFilter({...filterData, title_filter: ""})
    :
      setFilter({...filterData, title_filter: searchText})
  }
  ...
  return (
    <form className="relative" onSubmit={handleSearch}>
      ...
      <button className="absolute inset-0 right-auto group" data-testid="searchTextButton" type="submit" aria-label="Search">
